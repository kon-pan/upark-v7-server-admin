...
// Interfaces imports
import { IPostgresAdmin } from './interfaces/interface.db';
...
app.use(
  cors({
    origin: function (origin, callback) {
      ...
      if ([process.env.CLIENT_ADMIN_HOSTNAME].indexOf(origin) === -1) {
...
passport.serializeUser((user: IPostgresAdmin & { role: string }, done: any) => {
